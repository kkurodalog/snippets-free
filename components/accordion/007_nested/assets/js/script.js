 ...
 * - 仕掛け終えたルート要素に data-nested-ready を付ける。CSS はこれが付くまでの間だけ
 ...
 * - 親子とも data-nested は値なしで置く。スコープの判定は closest で行うため値を分ける必要がない。
 */
...
(function () {
  ...
  const accordionRoots = document.querySelectorAll(".c-accordion[data-nested]");
  ...
  function bindAccordion(root) {
    ...
    root.setAttribute("data-nested-ready", "");
  }
